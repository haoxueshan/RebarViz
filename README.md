...
| 条形基础 | TJ | 底板 B/T 配筋、分布筋、单梁/双梁或单墙/双墙条基 |
| 承台 | CT | 多桩承台、底筋配置、桩位布置 |
| 筏板基础 | FB | 柱网布置、底筋/顶筋、柱插筋 |

## 22G101-3 基础专题资料

- [22G101-3 基础专题整理](docs/22G101-3-foundation-notes.md) — 基于 OCR 内容清洗的页码速查、构造要点、设计需写明事项与后续产品化建议
- 当前应用重点覆盖独立基础、承台、筏形基础；条形基础内容已先整理到专题资料中，便于后续扩展
